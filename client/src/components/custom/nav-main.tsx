...
export function NavMain({
  ...
  return (
    <SidebarGroup>
      ...
      <div className="flex space-x-3 items-center pl-3 mb-5 cursor-pointer" onClick={() => navigate("/achievements")}>
        <div className="col-span-2">
          <Trophy></Trophy>
        </div>
